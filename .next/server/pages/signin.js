...
const CURRENT_USER_QUERY = client_["gql"]`
  query {
    authenticatedItem {
      ... on User {
        id
...
function useUser() {
  const {
    data
  } = Object(client_["useQuery"])(CURRENT_USER_QUERY);
...
function SignInPage() {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])(GridStyles, {
    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(SignIn, {}), /*#__PURE__*/Object(jsx_runtime_["jsx"])(SignUp, {}), /*#__PURE__*/Object(jsx_runtime_["jsx"])(RequestReset["a" /* default */], {})]
  });
}
